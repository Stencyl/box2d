...
class B2ContactConstraint
{
	...
	public static var pool:Array<B2ContactConstraint> = new Array<B2ContactConstraint>();
	public static var pooli:Int;
	
	public static function resetPool() 
	{
		pool = new Array<B2ContactConstraint>();
		pooli = 0;
	}
	...
	public static function getFromPool():B2ContactConstraint 
	{
		if(pooli < pool.length) 
		{
			var contact:B2ContactConstraint = pool[pooli];
			contact.reset();
			pooli++;
			return contact;
		} 
		...
		{
			var contact:B2ContactConstraint = new B2ContactConstraint();
			pool.push(contact);
			pooli++;
			return contact;
		}
